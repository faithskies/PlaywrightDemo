...
This folder is specifically for evaluation based 6 requested tests.

For reference, I have used JavaScript quite a bit for API testing but this is my first time ever using Playwright. Its been about two days since I started this project. I know there are probably better ways to go about this and Id love to get the opportunity to learn further.
